...
import { ProjectPage } from 'src/components/pages/project/ProjectPage'
...
import { ProjectPayload, SettingsPayload } from 'src/types'

const ProjectPreview = lazy(
  () => import('src/components/pages/project/ProjectPreview'),
)
...
export default function ProjectSlugRoute(props: PageProps) {
  const {
    homePageTitle, settings, project, preview, token,
  } = props
