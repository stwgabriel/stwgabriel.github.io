...
import { PagePayload, SettingsPayload } from 'src/types'

const PagePreview = lazy(() => import('src/components/pages/page/PagePreview'))
...
export default function ProjectSlugRoute(props: PageProps) {
  const {
    homePageTitle, settings, page, preview, token,
  } = props
